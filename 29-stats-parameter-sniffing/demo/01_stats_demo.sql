...
DBCC SHOW_Statistics (N'Application.Cities',N'_WA_Sys_00000002_17F790F9');

DBCC SHOW_Statistics (N'Application.CitiesCopy',N'CitiesCopy_CityName');

SELECT COUNT(*), COUNT(DISTINCT CityName)
FROM Application.CitiesCopy
WHERE CityName > N'Addison'
	AND CityName < N'Albany';
...
DBCC SHOW_Statistics (N'Sales.InvoiceLines',N'PK_Sales_InvoiceLines');
